package com.example.SangProj.Controller.admin;
...
import com.example.SangProj.Models.CategoryModel;
import com.example.SangProj.Service.ICategoryService;
...
public class CategoryController {
	...
	public ModelAndView edit(ModelMap model, @PathVariable("categoryId") Long categoryId) {
		Optional<CategoryEntity> otpCategory = categoryService.findById(categoryId);
		CategoryModel cateModel = new CategoryModel();
		
		if(otpCategory.isPresent()) {
			
			CategoryEntity entity = otpCategory.get();
